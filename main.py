...
from Depth_Estimation import stereovision
...
def to_depth_estimation(left, right):
    ...
    #while buffer < -2:
     #   time.sleep(1)
    print("in while")
    new_depth = stereovision.generate_depth_map(left, right)
...
if __name__ == '__main__':
    ...
    start1 = time.time()
    left = cv2.imread(r'C:\Users\rohit\Downloads\WhatsApp Image 2022-04-22 at 10.33.02 PM.jpeg')
    right = cv2.imread(r'C:\Users\rohit\Downloads\watermelon_right.jpeg')
    to_object_detection(left)
    print('Depth Estimstion')
